                ...
                <b-container mt="5">
                        <b-row>
                            ...
                            <b-col sm="1">
                                ...
                                <div>
                                    <b-button id="show-btn" @click="EliminarProducto()">Eliminar</b-button>
                                    <!-- @click="formSubmit() + showModal()" -->

                                    <b-modal ref="my-modal" hide-footer title="Eliminacion de Producto">
                                    <div class="d-block text-center">
                                        <h5>Registro Eliminado Correctamente</h5>
                                    </div>
    ...
    methods:
    {
        ...
        borrar(){
         ...
         UpdateProducto() {
            ...
            EliminarProducto(){ //HACER EL DELETE DE PRODUCTO
                axios.delete('https://localhost:44390/api/productos?', {
                     params: {
                            codigo:this.codigo 
                            }
               }).then(response => {
